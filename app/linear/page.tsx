          ...
          <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-16">
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="mt-8 max-w-xl text-center text-lg text-white/60 lg:text-xl">
                Recharger is not like all those chat-with-pdf apps. It certainly
                has a slightly different UI, so it worths your money.
              </h2>
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col md:items-center">
                ...
                <p className="mx-auto mt-4 text-left leading-relaxed text-white/50 md:max-w-2xl md:text-center lg:mt-8">
                  ...
                  Just ask and retrieve the information you need, all in a
                  simple chat.
                </p>
              </div>
                  ...
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-4 text-sm font-light leading-relaxed text-white/75">
                        Effortlessly upload the PDFs you want to chat with. Get
                        things started with just a few clicks and your documents
                        are ready for a chat.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 p-8">
                  ...
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-4 text-sm font-light leading-relaxed text-white/75">
                        Pop the questions, pull out information, or get a quick
                        summary of your documents using our smart AI. It's all
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 p-8">
                  ...
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-4 text-sm font-light leading-relaxed text-white/75">
                        Every answer you receive comes directly from your
                        uploaded documents – we always include the source for
                        full transparency.
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col items-center justify-center md:items-center">
                    ...
                    <p className="mx-auto mt-4 text-center leading-relaxed text-white/50 md:max-w-2xl lg:mt-8">
                      ...
                      <br className="hidden lg:block" />
                      Extract and calculate key metrics from your reports
                      instantly.
                    </p>
                  </div>
                  <div className="mt-8 grid gap-4 lg:mt-16 lg:grid-cols-2 lg:gap-8">
                      ...
                      <div className="bg-white/2.5 relative overflow-hidden rounded-2xl border border-white/10 shadow-md shadow-zinc-950/50 before:absolute before:inset-0 before:bg-[radial-gradient(640px_circle_at_476px_-64.0469px,rgba(255,255,255,0.1),transparent)]">
                        <div className="p-6 lg:p-8">
                          ...
                          <p className="mt-4 font-light leading-relaxed text-white/75">
                            Recharger automatically gives you helpful hints and
                            guesses what you might ask next. This makes
                            extracting data from your documents more intuitive
                            and efficient.
                          </p>
                        </div>
                    ...
                    <div className="lg:bg-white/2.5 lg:rounded-3xl lg:border lg:border-white/10 lg:p-2">
                      <div
                        style="--x:879px; --y:-427.047px; --spotlight-color-stops:rgba(255,255,255,0.1),transparent; --spotlight-size:640px;"
                      ...
                      >
                        ...
                        <div className="mt-2 p-6 md:p-8">
                          ...
                          <p className="mt-4 font-light leading-relaxed text-white/75">
                            Recharger dives deep into your documents,
                            identifying and pulling crucial metrics, especially
                            from complex financial and data reports. Simplify
                            your data processing and grasp key insights
                            effectively.
                          </p>
                        </div>
                      </div>
                  ...
                  <div>
                    <div className="flex flex-col items-center bg-[radial-gradient(35%_128px_at_50%_100%,theme(backgroundColor.white/5%),transparent)] pb-8 lg:pb-16">
                      ...
                      <h2 className="font-lead mt-4 max-w-xl text-center text-xl font-light leading-tight tracking-wide text-white lg:text-3xl">
                        Dive into AI-powered features. Chat, learn, and get the
                        most out of your documents in no time
                      </h2>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 lg:mt-16">
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-y-16">
                      ...
                      <div>
                        ...
                        <div className="ml-11 mt-2 pl-0.5 text-sm font-light leading-relaxed text-white/75">
                          Simplify legal jargon in contracts and official
                          documents
                        </div>
                      </div>
                      <div className="">
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div>
                  <div className="flex flex-col bg-[radial-gradient(35%_128px_at_50%_100%,hsla(0,0%,100%,.05),transparent)] pb-8 md:items-center lg:pb-16">
                    ...
                    <p className="mx-auto mt-4 text-left leading-relaxed text-white/50 md:max-w-2xl md:text-center lg:mt-8">
                      Don't just take our word for it. Read what others say
                      about Recharger.
                    </p>
                  </div>
                  <div className="h-px w-full bg-gradient-to-r from-transparent via-white/30 to-transparent"></div>
                  ...
                  <div className="flex w-max animate-marquee items-stretch [--duration:50s] hover:[animation-play-state:paused]">
                      ...
                      >
                        ...
                        <div className="relative flex h-full flex-col">
                          <div className="pb-8 font-light text-white/75">
                            Absolutely a game changer! Recharger completely
                            revolutionized how I extract data from my documents.
                            It's like having an intelligent conversation with my
                            PDFs!
                          </div>
                    ...
                    <div className="px-2.5">
                      <div
                        style={
                          {
                            // --x:1924.04px; --y:-155.063px; --spotlight-color-stops:rgba(255,255,255,0.2),transparent; --spotlight-size:350px;
                          }
                        }
                        className="relative h-full w-[28rem] transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                      >
                        ...
                        <div className="relative flex h-full flex-col">
                          <div className="pb-8 font-light text-white/75">
                            Recharger is a lifesaver. It's impressive how it
                            understands my questions and presents information
                            from a dense hundred-page report.
                          </div>
                          <div className="mt-auto flex items-center gap-4">
                            <img
                              alt="Caroline Lee"
                              src="https://images.generated.photos/mp3gkB9z2wwhyySWzQJMegNbvvLV6HbKQX1_h6BEYAc/rs:fit:256:256/czM6Ly9pY29uczgu/Z3Bob3Rvcy1wcm9k/LnBob3Rvcy92M18w/MDAwOTI5LmpwZw.jpg"
                              className="h-10 w-10 rounded-full"
                            />
                            <div className="flex flex-col">
                    ...
                    <div className="px-2.5">
                      <div
                        style={
                          {
                            // --x:1456.04px; --y:-155.063px; --spotlight-color-stops:rgba(255,255,255,0.2),transparent; --spotlight-size:350px;
                          }
                        }
                        className="relative h-full w-[28rem] transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                      >
                        ...
                        <div className="relative flex h-full flex-col">
                          <div className="pb-8 font-light text-white/75">
                            I use Recharger daily. Uploading my contracts,
                            asking directly what I need to know, and getting an
                            instant response - it doesn't get more convenient!
                          </div>
                          <div className="mt-auto flex items-center gap-4">
                            <img
                              alt="Tyler Thompson"
                              src="https://images.generated.photos/vOkveSlBohR880A8z67aLHImhPr7UHdnXg06pifYvZ4/rs:fit:256:256/czM6Ly9pY29uczgu/Z3Bob3Rvcy1wcm9k/LnBob3Rvcy92M18w/MDAyNjg4LmpwZw.jpg"
                              className="h-10 w-10 rounded-full"
                            />
                            <div className="flex flex-col">
                              <div className="text-white">Tyler Thompson</div>
                              <div className="text-sm text-white/50">
                                Legal Advisor, DEF Law
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="px-2.5">
                      <div
                        style={
                          {
                            // --x:988.043px; --y:-155.063px; --spotlight-color-stops:rgba(255,255,255,0.2),transparent; --spotlight-size:350px;
                          }
                        }
                        className="relative h-full w-[28rem] transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                      >
                        ...
                        <div className="relative flex h-full flex-col">
                          <div className="pb-8 font-light text-white/75">
                            Recharger's simplicity in understanding complex data
                            is stunning. It has saved me hours of work and made
                            my data analysis tremendously efficient.
                          </div>
                          <div className="mt-auto flex items-center gap-4">
                            <img
                              alt="Jake Harris"
                              src="https://images.generated.photos/d_r3VzW3lO5ZsdaHhoVX7msWku7YIrqP4Qn1yozJU54/rs:fit:256:256/czM6Ly9pY29uczgu/Z3Bob3Rvcy1wcm9k/LnBob3Rvcy92M18w/MDAyMTQ4LmpwZw.jpg"
                              className="h-10 w-10 rounded-full"
                            />
                            <div className="flex flex-col">
                              <div className="text-white">Jake Harris</div>
                              <div className="text-sm text-white/50">
                                Researcher, GHI University
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="px-2.5">
                      <div
                        style={
                          {
                            // --x:520.043px; --y:-155.063px; --spotlight-color-stops:rgba(255,255,255,0.2),transparent; --spotlight-size:350px;
                          }
                        }
                        className="relative h-full w-[28rem] transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                      >
                    ...
                    <div className="px-2.5">
                      <div
                        style={
                          {
                            // --x:52.0435px; --y:-155.063px; --spotlight-color-stops:rgba(255,255,255,0.2),transparent; --spotlight-size:350px;
                          }
                        }
                        className="relative h-full w-[28rem] transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                      >
                    ...
                    <div className="px-2.5">
                      <div
                        style={
                          {
                            // --x:-415.957px; --y:-155.063px; --spotlight-color-stops:rgba(255,255,255,0.2),transparent; --spotlight-size:350px;
                          }
                        }
                        className="relative h-full w-[28rem] transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                      >
                    ...
                    <div className="px-2.5">
                      <div
                        style={
                          {
                            // --x:-883.957px; --y:-155.063px; --spotlight-color-stops:rgba(255,255,255,0.2),transparent; --spotlight-size:350px;
                          }
                        }
                        className="relative h-full w-[28rem] transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                      >
              ...
              <div className="bg-white/2.5 relative py-16 md:rounded-3xl lg:rounded-[3rem] xl:px-24 xl:py-32">
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="mx-auto mt-4 text-center leading-relaxed text-white/50 md:max-w-2xl lg:mt-8">
                      Usually, these are made up as we have no users yet to ask
                      any. <br className="hidden lg:block" />
                    ...
                    <div className="mx-auto max-w-3xl">
                      <div className="group border-b border-white/10">
                        <div className="flex cursor-pointer items-center py-6">
                          <div className="text-white/75 transition hover:text-white">
                            What is Recharger?
                          </div>
                          <div className="relative ml-auto">
                            <svg
                              ...
                              stroke="currentColor"
                              aria-hidden="true"
                              className="h-6 w-6 rotate-45 text-white/50 transition-transform duration-500"
                            >
                              <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <div
                          ...
                          className="overflow-hidden transition-all duration-500 will-change-[height]"
                        >
                          <div className="pb-6 font-light text-white/75">
                            Recharger is an innovative app that allows you to
                            chat directly with your PDF documents to extract the
                            information you need. It simplifies document
                            understanding and helps you save valuable time.
                          </div>
                        </div>
                      </div>
                      <div className="group border-b border-white/10">
                        ...
                        >
                          <div className="pb-6 font-light text-white/75">
                            Recharger uses advanced AI tech to understand the
                            content of your PDFs. Just upload your document, ask
                            the app questions as if you were chatting with a
                            person, and get accurate and instant answers.
                          </div>
                        </div>
                      </div>
                      <div className="group border-b border-white/10">
                        <div className="flex cursor-pointer items-center py-6">
                          <div className="text-white/75 transition hover:text-white">
                            What types of documents can I use with Recharger?
                          </div>
                          <div className="relative ml-auto">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          <div className="pb-6 font-light text-white/75">
                            Recharger works with any PDF document, making it a
                            versatile tool — whether you're reading complex
                            contracts, lengthy reports, or detailed user
                            manuals.
                          </div>
                        </div>
                      </div>
                      <div className="group border-b border-white/10">
                        <div className="flex cursor-pointer items-center py-6">
                          <div className="text-white/75 transition hover:text-white">
                            Is there a limit to the number of documents I can
                            upload?
                          </div>
                          <div className="relative ml-auto">
                            <svg
                        ...
                        >
                          <div className="pb-6 font-light text-white/75">
                            The number of documents you can upload depends on
                            the type of account you have. For specific details,
            ...
            <div id="pricing" className="scroll-mt-8 py-8 lg:py-16">
              <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:items-center">
                  ...
                  <p className="mx-auto mt-4 text-left leading-relaxed text-white/50 md:max-w-2xl md:text-center lg:mt-8">
                    Get started for free and upgrade once you feel like it.
                    There's a plan for everyone, from individual users to large
                    teams.
                  </p>
                </div>
                <div className="mt-8 lg:mt-16">
                  <div className="mx-auto grid max-w-5xl gap-4 lg:grid-cols-3 lg:gap-0">
                    ...
                    <div
                      ...
                      className="relative transform-gpu overflow-hidden rounded-[--radius] p-8 [--radius:theme(borderRadius.2xl)] before:absolute before:inset-0 before:bg-[radial-gradient(var(--spotlight-size)_circle_at_var(--x)_var(--y),var(--spotlight-color-stops))] lg:[--radius:theme(borderRadius.3xl)]"
                    >
                      <div className="from-white/15 absolute inset-x-0 bottom-[--radius] top-0 rounded-t-[--radius] bg-gradient-to-b to-transparent"></div>
                      <div className="absolute inset-x-[--radius] top-0 h-px bg-gradient-to-r from-transparent via-white/25 to-transparent"></div>
                      <div className="absolute inset-px rounded-[calc(var(--radius)-1px)] bg-zinc-950"></div>
